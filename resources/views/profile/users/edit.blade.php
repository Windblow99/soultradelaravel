            ...
            <div class="col-md-8">
                ...
                <form action="{{route('profile.users.update', $user) }}" method="POST" enctype="multipart/form-data">
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-md-8">
                            <input id="email" type="email" class="form-control-plaintext @error('email') is-invalid @enderror" name="email" value="{{$user->email}}" required autocomplete="email" autofocus readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input id="profile_picture" type="file" class="form-control-file" name="profile_picture" accept="image/x-png,image/gif,image/jpeg">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input id="verification_document" type="file" class="form-control-file" name="verification_document" accept="image/x-png,image/gif,image/jpeg">
                        </div>
                    </div>
                    @endif
