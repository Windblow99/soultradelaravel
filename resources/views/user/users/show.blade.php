            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right">Categories</label>

                            <div class="col-md-6">
                                <label class="col-form-label text-md-right">{{implode(', ', $user->category()->get()->pluck('name')->toArray())}}</label>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right">Personalities</label>

                            <div class="col-md-6">
                                <label class="col-form-label text-md-right">{{implode(', ', $user->personality()->get()->pluck('name')->toArray())}}</label>
                            </div>
                        </div>
