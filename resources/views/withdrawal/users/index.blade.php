            ...
            <div class="col-md-8">
                ...
                <form action="{{route('withdrawal.users.store') }}" method="POST">
                    ...
                    <div class="form-group row mt-4">
                        <label for="amount" class="col-md-4 col-form-label text-md-right">Withdrawal Amount</label>
                    ...
                    <div class="form-group row">
                        <label for="previous_id" class="col-md-4 col-form-label text-md-right">Previous ID</label>

                        <div class="col-md-6">
                            <input id="previous_id" type="text" class="form-control-plaintext" name="previous_id" value="{{ $withdrawals->id }}" readonly>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="previous_hash" class="col-md-4 col-form-label text-md-right">Previous Hash</label>

                        <div class="col-md-6">
                            <input id="previous_hash" type="text" class="form-control-plaintext" name="previous_hash" value="{{ $withdrawals->previous_hash }}" readonly>
                        </div>
                    </div>
